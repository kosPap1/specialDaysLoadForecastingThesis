...
print('MAPE for 25th March with XGBoost is ' + str(mean_absolute_percentage_error(y_pred, testY) * 100))
print('MAPE for 25th March with MLP is ' + str(mean_absolute_percentage_error(y_pred_MLP, testY) * 100))
